...
public class global extends Fragment {
    ...
    TextView cases, deaths, recovered, Active, critical, tests, affectedCountries, affectedCountries_w, cases_w, population, population_w, todayCases, todayRecovered, todayDeaths, todayCases_w, todayDeaths_w, todayRecovered_w,
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        loader = view.findViewById(R.id.main_loader_global);
        mainScrollView = view.findViewById(R.id.global_frag_scroll_view);
        cases = view.findViewById(R.id.TotalCases_Textview_id);
        piechartLayout = view.findViewById(R.id.pie_chart_layout);
        todayCases = view.findViewById(R.id.TodayCases_textview_id);
        deaths = view.findViewById(R.id.death_Textview_id);//done
        todayDeaths = view.findViewById(R.id.todayDeaths_textview_id);
        recovered = view.findViewById(R.id.recovered_Textview_id);//done
        ...
        affectedCountries = view.findViewById(R.id.affected_countries_textview_id);
        affectedCountries_w = view.findViewById(R.id.affected_countries_words_textview_id);
...
//
            ...
            public void onErrorResponse(VolleyError error) {
                loader.clearAnimation();
                loader.setVisibility(View.GONE);
                Toast.makeText(getContext(), "Please switch on your Wifi or Mobile Data and try again later", Toast.LENGTH_SHORT).show();
            }
        });
        if (getActivity() != null) {
